    ...
    <div class="main-body_userInfo" :style="{'-webkit-overflow-scrolling': scrollMode}">
      <mt-loadmore :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill="false" ref="loadmore">
        <div style="min-height:11rem;">
          <tableLocked :datas="dataChiled" :no="false" :thead_1="2" :thead_2="2"   @getShowTeamTable="_getShowTeamTable" :startAndEndtime="postData">
          </tableLocked>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        dataChiled:{
          gridColumns:['rdate', 'username', 'sum_prize', 'sum_bonus', 'sum_point', 'profit_loss', 'sum_salary', 'sum_lose_salary', 'sum_activity', 'sum_netincome', 'sum_dividend', 'profit'],
    ...
    methods: {
      ...
      LastWeek () {
        ...
        this.postData.end_date = this.mUtils.setDateTime(1)+ ' 01:'+'59'
        this.end_date = this.mUtils.setDateTime(1)
        this._getSecondaryAgent()
      },
      beforeMeniscus() {
        this.isActive = 2
