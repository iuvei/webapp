    ...
    <div class="header_app_v">
      ...
      <div class="rechargeBox">
        ...
        <div class="boxList">
          ...
          <div class="rechargetR copys">{{bankInfo.acc_bankacc == '' ? (bankInfo.email == '' ? bankInfo.spr_account :
            bankInfo.email) : bankInfo.acc_bankacc}}
          </div>
          <p
            @click="_copys('acc_bankacc_hook',bankInfo.acc_bankacc == '' ? (bankInfo.email == '' ? bankInfo.spr_account : bankInfo.email) : bankInfo.acc_bankacc)"
            class="button_copy acc_bankacc_hook">点击复制</p>
        </div>
        <div class="boxList">
