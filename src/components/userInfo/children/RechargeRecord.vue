...
<template>
  <div>
    ...
    <div class="main" v-if="show">
      ...
      <div class="inputBox">
        <p class="searchtit">状态</p>
        <div class="select">
          <ul class="selectBox">
            <li class="left" :class="{activeStatus:isActiveStatus == item.status}" v-tap="{ methods:showname, item: item}"  v-for="(item,index) in winningState" :key="index" v-text="item.name"></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <mt-loadmore :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill="false" ref="loadmore">
        <div style="min-height:11rem;">
          <table class="record_table" width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tbody>
                <tr v-tap="{ methods: _recordDetails, item: item}" v-for="(item,index) in getData" align="center" style="height:1.2rem;">
