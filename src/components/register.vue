...
<template>
  <div class="login" id="login">
    ...
    <div class="log-user">
      <p class="userName"><span></span>
        <input type="text" placeholder="用户名" :class="'log-input' + (username==''?' log-input-empty':'')" v-model="username" @blur="checkUserName(username)">
      </p>
      <p class="passWord"><span></span>
        <input type="password" placeholder="密码" :class="'log-input' + (password==''?' log-input-empty':'')"  v-model="password" @blur="checkUserPass(password)">
      </p>
      <p class="conformPassWord"><span></span>
        <input type="password" placeholder="密码确认" :class="'log-input' + (password==''?' log-input-empty':'')"  v-model="repassword" @blur="affirmUserPass(repassword)">
      </p>
      <p class="tencentqq"><span></span>
        <input type="text" placeholder="QQ号" :class="'log-input' + (qq==''?' log-input-empty':'')"  v-model="qq" @blur="affirmqq(qq)">
      </p>
