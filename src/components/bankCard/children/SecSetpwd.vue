...
<template>
  <div>
    <headTop headTitle="重新设置提款密码" goBack='true'></headTop>
      ...
      methods: {
        actionOk(){
		          ...
		          if(!okpass.test(this.tkpass)){
        			...
        			let checks = this.$route.query.checkValue;
            	...
            	},{secpass:tk_password,confirm_pass:tk_confirmpwd,setsecurity:'yes',check:checks})
					},
      }
