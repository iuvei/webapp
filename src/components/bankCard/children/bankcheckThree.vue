...
<template>
  <div>
    <headTop headTitle="解绑银行卡" goBack='true'></headTop>
    <div class="header_app_v">
      <p class="tips">解绑绑定银行卡需提供您的卡号信息！</p>
      <ul class="userBox">
  ...
  export default {
      ...
      methods: {
      		ok(){
      				...
      				let param = {flag:'del',account_name:this.openname,account:this.banknumber,'id':bankId};
